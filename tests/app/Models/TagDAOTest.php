...
use FreshRss\Models\TagDAOPGSQL;
use FreshRss\Models\TagDAOSQLite;
use PHPUnit\Framework\TestCase;

/**
 * Tests for the database-specific `INSERT ... ON DUPLICATE` variants used when tagging entries.
 */
final class TagDAOTest extends TestCase {
	...
	public function test_sqlIgnoreConflict_forMySQL(): void {
		self::assertSame(
			...
			TagDAO::sqlIgnoreConflict(self::SQL),
		);
	}
	...
	public function test_sqlIgnoreConflict_forSQLite(): void {
		self::assertSame(
			...
			TagDAOSQLite::sqlIgnoreConflict(self::SQL),
		);
	}
	...
	public function test_sqlIgnoreConflict_forPostgreSQL(): void {
		self::assertSame(
			...
			TagDAOPGSQL::sqlIgnoreConflict(self::SQL),
		);
	}
}
