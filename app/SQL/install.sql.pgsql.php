...
ALTER TABLE `_feed`
	...
	ALTER COLUMN "pathEntries" SET DATA TYPE VARCHAR(65535),
...
ALTER TABLE `_entry`
	...
	ALTER COLUMN "title" SET DATA TYPE VARCHAR(65535),
	ALTER COLUMN "author" SET DATA TYPE VARCHAR(65535),
	ALTER COLUMN "link" SET DATA TYPE VARCHAR(32768),
	ALTER COLUMN "tags" SET DATA TYPE VARCHAR(65535);
