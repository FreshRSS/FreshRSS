...
ALTER TABLE `_feed`
	...
	MODIFY COLUMN `pathEntries` VARCHAR(65535) DEFAULT NULL,
	MODIFY COLUMN `httpAuth` VARCHAR(1024) DEFAULT NULL;
ALTER TABLE `_entry`
	MODIFY COLUMN `date` BIGINT,
	MODIFY COLUMN `lastSeen` BIGINT DEFAULT 0,
	MODIFY COLUMN `guid` VARCHAR(767) NOT NULL,
	MODIFY COLUMN `title` VARCHAR(65535) NOT NULL,
	MODIFY COLUMN `author` VARCHAR(65535),
	MODIFY COLUMN `link` VARCHAR(32768) NOT NULL,
	MODIFY COLUMN `tags` VARCHAR(65535);
