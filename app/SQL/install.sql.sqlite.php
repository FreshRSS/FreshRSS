...
CREATE INDEX IF NOT EXISTS entry_last_user_modified_index ON `entry`(`lastUserModified`);	-- //v1.1.1
...
CREATE INDEX IF NOT EXISTS entrytmp_last_user_modified_index ON `entrytmp`(`lastUserModified`);	-- //v1.1.1
...
$GLOBALS['SQL_UPDATE_MINOR'] = <<<'SQL'
	ALTER TABLE `entry` ADD `lastUserModified` BIGINT DEFAULT 0;	-- 1.20.0
	ALTER TABLE `entrytmp` ADD `lastUserModified` BIGINT DEFAULT 0;	-- 1.20.0
	CREATE INDEX IF NOT EXISTS entry_last_user_modified_index ON `entry`(`lastUserModified`);	-- //v1.1.1
	CREATE INDEX IF NOT EXISTS entrytmp_last_user_modified_index ON `entrytmp`(`lastUserModified`);	-- //v1.1.1
SQL;
