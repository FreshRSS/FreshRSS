...
CREATE INDEX IF NOT EXISTS entry_last_user_modified_index ON `entry`(`lastUserModified`);	-- //v1.27.1
...
CREATE INDEX IF NOT EXISTS entrytmp_last_user_modified_index ON `entrytmp`(`lastUserModified`);	-- //v1.27.1
