...
class FreshRSS_tag_Controller extends FreshRSS_ActionController {
	...
	public function updateAction(): void {
		...
		if (Minz_Request::isPost()) {
			...
			if ($ok) {
				Minz_Request::good(_t('feedback.tag.updated'), $url_redirect, showNotification: FreshRSS_Context::userConf()->good_notification_timeout > 0);
			} else {
	...
	public function addAction(): void {
		...
		Minz_Request::good(_t('feedback.tag.created', $name), $url_redirect, showNotification: FreshRSS_Context::userConf()->good_notification_timeout > 0);
	}
	...
	public function renameAction(): void {
		...
		Minz_Request::good(_t('feedback.tag.renamed', $sourceName, $targetName), ['c' => 'tag', 'a' => 'index'], showNotification: FreshRSS_Context::userConf()->good_notification_timeout > 0);
	}
