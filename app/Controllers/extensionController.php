...
class FreshRSS_extension_Controller extends FreshRSS_ActionController {
	...
	public function enableAction(): void {
		...
		if (Minz_Request::isPost()) {
			...
			if ($conf !== null && $res === true) {
				...
				Minz_Request::good(_t('feedback.extensions.enable.ok', $ext_name), $url_redirect, showNotification: FreshRSS_Context::userConf()->good_notification_timeout > 0);
			} else {
	...
	public function disableAction(): void {
		...
		if (Minz_Request::isPost()) {
			...
			if ($conf !== null && $res === true) {
				...
				Minz_Request::good(_t('feedback.extensions.disable.ok', $ext_name), $url_redirect, showNotification: FreshRSS_Context::userConf()->good_notification_timeout > 0);
			} else {
	...
	public function removeAction(): void {
		...
		if (Minz_Request::isPost()) {
			...
			if ($res) {
				Minz_Request::good(_t('feedback.extensions.removed', $ext_name), $url_redirect, showNotification: FreshRSS_Context::userConf()->good_notification_timeout > 0);
			} else {
