...
class FreshRSS_configure_Controller extends Minz_ActionController {
	 ...
	 *   - user login duration for form auth (default: FreshRSS_FormAuth::DEFAULT_COOKIE_DURATION)
	 *
	...
	public function systemAction() {
		...
		if (Minz_Request::isPost()) {
			...
			$limits['cookie_duration'] = Minz_Request::param('cookie-duration', FreshRSS_FormAuth::DEFAULT_COOKIE_DURATION);
