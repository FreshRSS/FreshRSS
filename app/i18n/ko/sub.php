...
return array(
	...
	'feed' => array(
		...
		'filteractions' => array(
			'_' => '필터 동작',
			'help' => '한 줄에 한 검색 필터를 작성해 주세요. Operators <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#with-the-search-field" target="blank">see documentation</a>.',	// DIRTY
		),
		'information' => '정보',
		'keep_min' => '최소 유지 글 개수',
		'kind' => array(
