...
return array(
	...
	'category' => array(
		...
		'error' => 'Deze dynamische OPML-categorie heeft een probleem ondervonden. Controleer of de OPML-URL nog steeds bereikbaar is en of het maximale aantal feeds per gebruiker niet is overschreden.',
	...
	'feed' => array(
		...
		'export-as-opml' => array(
			'download' => 'Downloaden',
			'help' => 'XML-bestand (subset van gegevens. <a href="https://freshrss.github.io/FreshRSS/en/developers/OPML.html" target="_blank">Zie documentatie</a>)',
		...
		'filteractions' => array(
			'_' => 'Filteracties',
			'help' => 'Voer één zoekfilter per regel in. Zie de <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#with-the-search-field" target="_blank">documentatie</a> voor operators.',
		...
		'icon' => 'Pictogram',
		'information' => 'Informatie',
		'keep_adding_feed' => 'Voeg vervolgens meer feeds toe',
		...
		'kind' => array(
			...
			'json_dotnotation' => array(
				...
				'item' => array(
					...
					'help' => 'JSON-puntnotatiepad naar de array met de items, bv. <code>$</code> of <code>nieuwsItems</code>',
				),
		...
		'last-entry-publication-date' => 'Laatst gepubliceerd artikel <time datetime="%1$s" title="%1$s">%2$s</time>.',
		'last-entry-received-date' => 'Laatst ontvangen artikel <time datetime="%1$s" title="%1$s">%2$s</time>.',
		'last-error-date' => 'Laatste foutieve update <time datetime="%1$s" title="%1$s">%2$s</time>.',
		'last-update' => 'Laatste succesvolle update <time datetime="%1$s" title="%1$s">%2$s</time>.',
		'maintenance' => array(
			'clear_cache' => 'Cache leegmaken',
			'clear_cache_help' => 'Cache voor deze feed leegmaken.',
			'reload_articles' => 'Artikels herladen',
			'reload_articles_help' => 'Artikelen herladen en volledige inhoud ophalen als er een selector is gedefinieerd.',
			'title' => 'Onderhoud',
		),
