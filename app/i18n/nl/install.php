...
return array(
	...
	'check' => array(
		...
		'docroot' => array(
			'nok' => 'De documentroot van uw webserver lijkt niet naar de map <code>./p/</code> te verwijzen. Andere mappen zoals <code>./data/</code> zijn mogelijk openbaar toegankelijk.',
			'ok' => 'De documentroot van uw webserver verwijst correct naar de map <code>./p/</code>.',
		),
		'dom' => array(
		...
		'gmp' => array(
			'nok' => 'De vereiste GMP-uitbreiding voor 32-bits PHP (pakket php-gmp) kan niet worden gevonden.',
			'ok' => 'U hebt de vereiste GMP-uitbreiding voor 32-bits PHP.',
		),
		'intl' => array(
