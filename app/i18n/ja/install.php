...
return array(
	...
	'check' => array(
		...
		'cache' => array(
			'nok' => ' <em>%1$s</em> ディレクトリ <em>%5$s</em> (Owner: %2$s, Group: %3$s, Rights: %4$s) ユーザーのアクセス権限を確認してください。HTTPサーバーを書き込むには権限が必要です。 (User name: %5$s)',	// DIRTY
		...
		'data' => array(
			'nok' => 'この <em>%1$s</em> ディレクトリの <em>%5$s</em> (Owner: %2$s, Group: %3$s, Rights: %4$s) ユーザーのアクセス権限を確認してください。HTTPサーバーは編集権限を必要としています。 (User name: %5$s)',	// DIRTY
