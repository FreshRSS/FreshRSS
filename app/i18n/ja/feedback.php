	...
	'sub' => array(
		...
		'feed' => array(
			...
			'selector_preview' => array(
				...
				'no_result' => '一致するものがありませんでした。代わりに元のフィード本文を表示します。',
				'selector_empty' => 'セレクターが空です。プレビューを作成するにはセレクターを指定してください。',
			),
			'updated' => 'フィードを更新しました。',
		),
		'purge_completed' => '不要データの削除が完了しました（%d件の記事を削除しました）',
	),
	'tag' => array(
		'created' => 'ラベル「%s」を作成しました',
		'error' => 'ラベルを更新できませんでした',
		'name_exists' => 'このラベル名は既に存在します',
		'renamed' => 'ラベル「%s」の名前を「%s」に変更しました',
		'updated' => 'ラベルが更新されました',
	),
	'update' => array(
		'can_apply' => 'FreshRSSは<strong>バージョン %s</strong>に更新されます。',
		'error' => 'アップデート中にエラーが発生しました：%s',
		'file_is_nok' => 'FreshRSSのアップデート（<strong>バージョン %s</strong>）を利用できますが、<em>%s</em>ディレクトリの権限を確認してください。HTTPサーバーに書き込み権限が必要です。',
		'finished' => 'アップデートが完了しました',
		'none' => '適用できるアップデートはありません',
		'server_not_found' => 'アップデートサーバーが見つかりません。[%s]',
	),
	'user' => array(
		'created' => array(
			'_' => 'ユーザー「%s」を作成しました',
			'error' => 'ユーザー「%s」を作成できません',
		),
		'deleted' => array(
			'_' => 'ユーザー「%s」を削除しました',
			'error' => 'ユーザー「%s」を削除できません',
		),
		'updated' => array(
			'_' => 'ユーザー「%s」を更新しました',
