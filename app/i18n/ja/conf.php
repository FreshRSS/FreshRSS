...
return array(
	...
	'query' => array(
		...
		'state_all' => 'すべての記事を表示する',
		'state_favorite' => 'お気に入りの記事を表示する',
		'state_not_favorite' => 'お気に入りでない記事を表示する',
		'state_read' => 'すべての既読の記事を表示する',
		'state_read_favorite' => 'お気に入りの既読の記事を表示する',
		'state_read_not_favorite' => 'お気に入りでない既読の記事を表示する',
		'state_unread' => '未読の記事を表示する',
		'state_unread_favorite' => 'お気に入りの未読の記事を表示する',
		'state_unread_not_favorite' => 'お気に入りでない未読の記事を表示する',
		'title' => 'ユーザークエリ',
	),
	'reading' => array(
		'_' => 'リーディング',
