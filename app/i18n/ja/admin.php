...
return array(
	'auth' => array(
		'allow_anonymous' => 'デフォルトユーザー（%s）の記事がログインしていないときでも読めるようにする。',
		'allow_anonymous_refresh' => '未ログインユーザーでも記事を更新できるようにします。',
		'api_enabled' => '<abbr>API</abbr>アクセスを許可します<small>（モバイルアプリやユーザークエリの共有に必要）</small>',
	...
	'user' => array(
		...
		'list' => 'ユーザーリスト',
		'number' => '%d個のアカウントがあります。',
		'numbers' => '%d個のアカウントが作られました。',
