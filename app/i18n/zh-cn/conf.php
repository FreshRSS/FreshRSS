...
return array(
	...
	'profile' => array(
		...
		'api' => array(
			'_' => 'API 管理',
			'api_not_set' => 'API密码未设置',	// TODO
			'api_set' => 'API密码已设置',	// TODO
			'check_link' => 'Check API status via: <kbd><a href="../api/" target="_blank">%s</a></kbd>',	// TODO
			'disabled' => 'The API access is disabled.',	// TODO
			'documentation_link' => 'See the <a href="https://freshrss.github.io/FreshRSS/en/users/06_Mobile_access.html#access-via-mobile-app" target="_blank">documentation and list of known apps</a>',	// TODO
			'help' => 'See <a href="http://freshrss.github.io/FreshRSS/en/users/06_Mobile_access.html#access-via-mobile-app" target=_blank>documentation</a>',	// TODO
		),
		'change_password' => '修改密码',	// TODO
		'confirm_new_password' => '确认新密码',	// TODO
	...
	'reading' => array(
		...
		'article' => array(
			...
			'feed_title' => '订阅源标题',
			'icons' => array(
				'_' => '文章图标位置<br /><small>（仅阅读视图）</small>',	// TODO
				'above_title' => '标题之上',	// TODO
				'with_authors' => '与作者和日期在同一行',	// TODO
			),
			'tags' => array(
				'_' => '文章标签',
				'both' => '页脚与页眉',
		...
		'show' => array(
			...
			'adaptive' => '若有未读项就显示未读，否则显示所有文章',	// TODO
			'all_articles' => '显示所有',
			'all_categories' => '所有分类',
			'no_category' => '无分类',
			'remember_categories' => '记住打开的分类',
			'unread' => '只显示未读',
			'unread_or_favorite' => '显示未读及收藏',	// TODO
		),
