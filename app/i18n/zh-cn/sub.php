...
return array(
	...
	'feed' => array(
		...
		'filteractions' => array(
			'_' => '过滤动作',
			'help' => '每行写一条过滤搜索 Operators <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#with-the-search-field" target="blank">see documentation</a>.',	// DIRTY
		),
		'information' => '信息',
		'keep_min' => '至少保存的文章数',
		'kind' => array(
