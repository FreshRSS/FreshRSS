...
return array(
	...
	'check' => array(
		...
		'docroot' => array(
			'nok' => 'La raíz de documentos de tu servidor web no parece apuntar a la carpeta <code>./p/</code>. Puede que otras carpetas, como <code>./data/</code>, sean accesibles públicamente.',
			'ok' => 'La raíz de documentos de tu servidor web apunta correctamente a la carpeta <code>./p/</code>.',
		),
		'dom' => array(
		...
		'gmp' => array(
			'nok' => 'No se encuentra la extensión GMP necesaria para PHP de 32 bits (paquete php-gmp).',
			'ok' => 'Tienes la extensión GMP necesaria para PHP de 32 bits.',
		),
		'intl' => array(
