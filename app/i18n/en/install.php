...
return array(
	...
	'check' => array(
		...
		'cache' => array(
			'nok' => 'Check permissions on the <em>%1$s</em> directory for <em>%2$s</em> user (Owner: %s, Group: %s, Rights: %s).<br />The HTTP server (User name: %s) must have write permissions.',
