...
return array(
	...
	'display' => array(
		...
		'website' => array(
			'full' => 'Icon and name',
			'full_below' => 'Icon and name below the title',
			'icon' => 'Icon only',
			'label' => 'Website',
			'name' => 'Name only',
			'none' => 'None',
	...
	'profile' => array(
		...
		'api' => array(
			...
			'help' => 'See <a href="https://freshrss.github.io/FreshRSS/en/users/06_Mobile_access.html#access-via-mobile-app" target=_blank>documentation</a>',
	...
	'query' => array(
		...
		'filter' => array(
			...
			'include_article_tags_label' => 'Include article tags from feeds',
			'include_user_labels_label' => 'Include user labels, with prefix:',
			'order' => 'Sort by date',
			'search' => 'Expression',
