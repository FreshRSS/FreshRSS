...
return array(
	...
	'feed' => array(
		...
		'published' => array(
			'_' => 'Published',
			'beforeLastYear' => 'Published before last year',
			'earlierThisMonth' => 'Published earlier this month',
			'earlierThisYear' => 'Published earlier this year',
			'future' => 'Published in the future',
			'lastMonth' => 'Published last month',
			'lastYear' => 'Published last year',
			'today' => 'Published today',
			'yesterday' => 'Published yesterday',
		),
		'received' => array(
			'_' => 'Received',
			'beforeLastYear' => 'Received before last year',
			'earlierThisMonth' => 'Received earlier this month',
			'earlierThisYear' => 'Received earlier this year',
			'future' => 'Received in the future',
			'lastMonth' => 'Received last month',
			'lastYear' => 'Received last year',
		...
		'userModified' => array(
			'_' => 'Modified by user',
			'beforeLastYear' => 'Modified by user before last year',
			'earlierThisMonth' => 'Modified by user earlier this month',
			'earlierThisYear' => 'Modified by user earlier this year',
			'future' => 'Modified by user in the future',
			'lastMonth' => 'Modified by user last month',
			'lastYear' => 'Modified by user last year',
