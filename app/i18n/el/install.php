...
return array(
	...
	'check' => array(
		...
		'cache' => array(
			'nok' => 'Ελέγξτε τα δικαιώματα στον κατάλογο <em>%1$s</em> για τον χρήστη <em>%2$s</em> (Owner: %s, Group: %s, Rights: %s).<br />Ο διακομιστής HTTP πρέπει (Username: %s) να έχει δικαίωμα εγγραφής.',	// DIRTY
