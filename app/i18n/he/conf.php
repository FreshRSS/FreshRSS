...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'שמירת סדר המיון הידני בעת ניווט',
		'sticky_sort_help' => 'קובע אם סדר המיון הידני האחרון נשאר פעיל או שכל קטגוריה או הזנה משתמשת תמיד בהגדרת ברירת המחדל או הכללית שלה.',
		'title' => 'קריאה',
		'view' => array(
