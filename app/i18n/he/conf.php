...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'שמירת סדר המיון הנוכחי בעת מעבר בין קטגוריות והזנות',
		'sticky_sort_help' => 'כאשר האפשרות אינה מסומנת, כל קטגוריה והזנה נפתחות עם סדר המיון שמשמש כברירת המחדל שלהן (או עם קריטריון המיון הכללי שלמעלה אם לא הוגדר אחד), במקום לשמור על סדר המיון שבחרת לאחרונה.',
		'title' => 'קריאה',
		'view' => array(
