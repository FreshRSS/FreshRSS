...
return array(
	...
	'extensions' => array(
		...
		'invalid_view_mode' => 'حالت نمایش «%s» نامعتبر است! بازگشت به «نمای عادی».',
	...
	'import_export' => array(
		...
		'feeds_imported' => 'فیدهای شما وارد شده‌اند. اگر کار وارد کردن تمام شده است، اکنون می‌توانید روی دکمه <i>به‌روزرسانی فیدها</i> کلیک کنید.',
	...
	'sub' => array(
		...
		'category' => array(
			...
			'over_max' => 'شما به حد مجاز دسته‌بندی‌های خود رسیده‌اید (%d)',
	...
	'update' => array(
		...
		'file_is_nok' => 'به‌روزرسانی FreshRSS موجود است (<strong>نسخه %s</strong>)، اما مجوزهای دایرکتوری <em>%s</em> را بررسی کنید. سرور HTTP باید مجوز نوشتن داشته باشد',
