...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'حفظ ترتیب مرتب‌سازی فعلی هنگام جابه‌جایی میان دسته‌ها و خوراک‌ها',
		'sticky_sort_help' => 'وقتی غیرفعال باشد، هر دسته و خوراک با ترتیب مرتب‌سازی پیش‌فرض خود باز می‌شود (یا با معیار مرتب‌سازی سراسری بالا اگر هیچ‌کدام تنظیم نشده باشد)، به‌جای حفظ ترتیبی که آخرین بار انتخاب کرده‌اید.',
		'title' => ' خواندن',
		'view' => array(
