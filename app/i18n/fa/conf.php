...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'حفظ ترتیب مرتب‌سازی دستی هنگام پیمایش',
		'sticky_sort_help' => 'تعیین می‌کند که آیا آخرین ترتیب مرتب‌سازی دستی فعال بماند یا هر دسته یا خوراک همیشه از تنظیم پیش‌فرض یا سراسری خود استفاده کند.',
		'title' => ' خواندن',
		'view' => array(
