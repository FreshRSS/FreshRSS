...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'Сохранять текущий порядок сортировки при переходе между категориями и лентами',
		'sticky_sort_help' => 'Если флажок снят, каждая категория и лента открывается со своим порядком сортировки по умолчанию (или с общим критерием сортировки выше, если он не задан), вместо сохранения последнего выбранного порядка сортировки.',
		'title' => 'Чтение',
		'view' => array(
