...
return array(
	...
	'feed' => array(
		...
		'published' => array(
			'_' => 'Publié',
			'beforeLastYear' => 'Publié avant l’année dernière',
			'earlierThisMonth' => 'Publié plus tôt ce mois-ci',
			'earlierThisYear' => 'Publié plus tôt cette année',
			'future' => 'Publié dans le futur',
			'lastMonth' => 'Publié le mois dernier',
			'lastYear' => 'Publié l’année dernière',
			'today' => 'Publié aujourd’hui',
			'yesterday' => 'Publié hier',
		),
		'received' => array(
			'_' => 'Reçu',
			'beforeLastYear' => 'Reçu avant l’année dernière',
			'earlierThisMonth' => 'Reçu plus tôt ce mois-ci',
			'earlierThisYear' => 'Reçu plus tôt cette année',
			'future' => 'Reçu dans le futur',
			'lastMonth' => 'Reçu le mois dernier',
			'lastYear' => 'Reçu l’année dernière',
		...
		'userModified' => array(
			...
			'beforeLastYear' => 'Modifié par l’utilisateur avant l’année dernière',
			'earlierThisMonth' => 'Modifié par l’utilisateur plus tôt ce mois-ci',
			'earlierThisYear' => 'Modifié par l’utilisateur plus tôt cette année',
			'future' => 'Modifié par l’utilisateur dans le futur',
			'lastMonth' => 'Modifié par l’utilisateur le mois dernier',
			'lastYear' => 'Modifié par l’utilisateur l’année dernière',
