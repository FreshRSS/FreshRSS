...
return array(
	...
	'check' => array(
		...
		'cache' => array(
			'nok' => 'Veuillez vérifier les droits de l’utilisateur <em>%5$s</em> sur le répertoire <em>%1$s</em> (Owner: %2$s, Group: %3$s, Rights: %4$s).<br />Le serveur HTTP (User name: %5$s) doit être capable d’écrire dedans.',	// DIRTY
