...
return array(
	...
	'search' => array(
		'advanced_search_help' => 'Ця форма допомагає створювати пошукові запити, але ручні запити ще потужніші.',
		'authors' => 'Автори',
		'categories' => 'Категорії',
		'content' => 'Вміст',
		'date_from' => 'Від',
		'date_modified' => 'Дата модифікації на сервері',
		'date_past' => 'У минулому',
		'date_published' => 'Дата публікації',
		'date_range' => 'Діапазон дат',
		'date_received' => 'Дата отримання',
		'date_to' => 'До',
		'date_user' => 'Дата модифікації користувачем',
		'feeds' => 'Стрічки',
		'free_text' => 'Вільний текст',
		'free_text_help' => 'Шукати як у заголовку, так і у вмісті',
		'full_documentation' => 'Переглянути <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#with-the-search-field" target="_blank">повну документацію з пошуку</a>',
		'labels' => 'Мої мітки',
		'multiple_help' => 'Виберіть одне або кілька (утримуйте <kbd>Ctrl</kbd> або <kbd>Cmd</kbd>)',
		'sources' => 'Джерела',
		'tags' => 'Теги статей',
		'text' => 'Текстовий пошук',
		'text_help' => 'Кілька рядків об\'єднуються логічним <i>АБО</i>. Також підтримує <a href="https://freshrss.github.io/FreshRSS/en/users/10_filter.html#regex" target="_blank">регулярні вирази</a>.',
		'text_placeholder' => 'Ключове слово',
		'title' => 'Заголовок',
		'url' => 'URL-адреса',
		'user_queries' => 'Запити користувача',
	),
	'share' => array(
