...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'Зберігати поточний порядок сортування під час переходу між категоріями та стрічками',
		'sticky_sort_help' => 'Якщо прапорець знято, кожна категорія та стрічка відкривається з власним типовим порядком сортування (або із загальним критерієм сортування вище, якщо жоден не налаштовано), замість збереження востаннє вибраного порядку сортування.',
		'title' => 'Читання',
		'view' => array(
