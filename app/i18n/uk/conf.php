...
return array(
	...
	'reading' => array(
		...
		'sticky_sort' => 'Зберігати ручний порядок сортування під час навігації',
		'sticky_sort_help' => 'Визначає, чи зберігається останній ручний порядок сортування, чи кожна категорія або стрічка завжди використовує власне типове або глобальне налаштування.',
		'title' => 'Читання',
		'view' => array(
