...
class FreshRSS_LogDAO {
	public static function lines() {
		$logs = array();
		$handle = @fopen(join_path(DATA_PATH, 'users', Minz_Session::param(CURRENT_USER, '_'), LOG_FILENAME), 'r');
		if ($handle) {
	...
	public static function truncate() {
		file_put_contents(join_path(DATA_PATH, 'users', Minz_Session::param(CURRENT_USER, '_'), LOG_FILENAME), '');
