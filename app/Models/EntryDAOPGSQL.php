...
BEGIN
	DELETE FROM `' . $this->prefix . 'entrytmp` AS etmp WHERE EXISTS (SELECT 1 FROM `' . $this->prefix . 'entry` AS ereal WHERE etmp.id_feed = ereal.id_feed AND etmp.guid = ereal.guid);
