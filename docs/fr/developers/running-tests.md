...
nav_order: 30
redirect_from:
  - /en/developers/03_Running_tests.html
---

# Running tests

FreshRSS is tested with [PHPUnit](https://phpunit.de/),
[PHPStan](https://phpstan.org/),
[PHP\_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer/), and
more.  No code should be merged in `edge` if the tests don’t pass.
...
Some syntax, formatting, whitespace, and i18n conventions can be fixed
automatically with:
...
Some tests can run inside some Docker images, in particular to test against
minimum and maximum versions of PHP:
...
some issues.  Check the [description to retrieve a
snapshot](reporting-bugs.md#how-to-provide-feed-data).
