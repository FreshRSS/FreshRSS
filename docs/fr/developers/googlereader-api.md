...
nav_order: 80
redirect_from:
  - /en/developers/06_GoogleReader_API.html
---
...
See also the [page about our Fever compatible API](fever-api.md) for another
possibility (less powerful).
...
1. On the same FreshRSS API page, note the address given under “Your API
   address”, like `https://freshrss.example.net/api/greader.php`
2. Type the API address in a client, together with your FreshRSS username,
...
* [*Additional synchronisation tips* by
  Alkarex](https://github.com/jocmp/capyreader/discussions/533#discussioncomment-11341808)
