...
If you can’t find any themes you like, it’s always possible to [create your own](../developers/writing-themes.md) and [install it](../admins/themes.md). For small theme changes, the official [CustomCSS extension](https://github.com/FreshRSS/Extensions) is recommended.
...
At the moment, FreshRSS supports [20+ sharing services](sharing-services.md), ranging from self-hosted services (Shaarli, etc.) to proprietary services (Facebook, etc.).
