...
Read about [the filters](./filtering-articles.md) to learn the different ways to search and filter
...
* `search`: Filter the user query results based on search filter. See [Filtering articles](./filtering-articles.md) for more details.
