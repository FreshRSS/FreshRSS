...
Thanks to our contributors, FreshRSS is translated into [more than 20 languages](./users/configuration.md#language). This section will explain the basics of internationalization in FreshRSS, from translating the application to your own language to making a specific change.
