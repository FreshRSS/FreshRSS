...
Before being applied, migrations are sorted by filenames (see the [`strnatcmp`](https://www.php.net/strnatcmp) function). Already applied migrations are skipped (the list can be found in the `data/applied_migrations.txt` file).
