...
* `frss:priority`: Used for priority / visibility of the articles of that feed / category. Can be: `important`, `use_category_setting` (default for feed), `main` (default for category), `category`, `feed`, `hidden`.
