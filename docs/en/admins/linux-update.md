...
Please read the general advice from “[Updating](updating.md)” before applying any command from this guide.

## Pausing automatic feed updates

If [Automatic Feed Updating](feed-updates.md) has been configured, temporarily suspend the automatic feed updates during the upgrade process.
...
3. Discard manual changes and delete manual additions
	...
	Note: If you wish to keep your changes, it’s better to [create a pull request](https://github.com/FreshRSS/FreshRSS/compare) or [an extension](../developers/writing-extensions.md).
