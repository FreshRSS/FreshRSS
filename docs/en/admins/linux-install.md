...
nav_order: 30
redirect_from:
  - /en/admins/06_LinuxInstall.html
---

# Installation on Debian/Ubuntu

This tutorial will give you step-by-step commands to install the latest stable release of FreshRSS with Apache and MySQL using git. It’s always recommended that you [backup your installation](backup.md) before updating
...
Then, you have to configure Apache. You can create a file in `/etc/apache2/sites-available`, based on [our example configuration file](server-config.md). Once you’re done, create a symbolic link from this file to the `sites-enabled` folder:
