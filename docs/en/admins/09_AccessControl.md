...
Entries are separated by newlines, and must be a `host:port` combination, for example `127.0.0.1:8080`, `rssbridge.local:443` or a CIDR notation ('0.0.0.0/0' to allow any IPv4, `::/0` to allow any IPv6).
