...
nav_order: 120
redirect_from:
  - /en/admins/09_AccessControl.html
---
...
See also another option for Authentik, [using the OAuth2 Provider with OpenID](authentik.md).
...
* See [dedicated section](openid-connect.md).
