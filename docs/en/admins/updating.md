...
nav_order: 50
redirect_from:
  - /en/admins/04_Updating.html
---

# Updating

This is the general procedure; for specific Linux commands, see [Updating on Linux](linux-update.md).
...
See the [Backup page](backup.md) for the full list and procedures.
...
See [Updating on Linux](linux-update.md#using-git) for the same flow with `sudo` and the FreshRSS permissions helper.
