...
nav_order: 130
redirect_from:
  - /en/admins/16_OpenID-Connect.html
---
...
This is one of the [access control methods](access-control.md) supported by FreshRSS.
...
* Authentik: [here (freshrss.org)](authentik.md) or [here (goauthentik.io)](https://goauthentik.io/integrations/services/freshrss/)
* Authelia: [here (authelia.com)](https://www.authelia.com/integration/openid-connect/freshrss/)
* Pocket ID: [here (freshrss.org)](pocket-id.md)
