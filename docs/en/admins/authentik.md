...
nav_order: 140
redirect_from:
  - /en/admins/16_OpenID-Connect-Authentik.html
---

# Setting up Authentik

**[authentik](https://goauthentik.io/)** is an open-source Identity Provider compatible with OpenID Connect (OIDC) (see [FreshRSS’ OpenID Connect documentation](openid-connect.md)).
...
See [FreshRSS’ OpenID Connect documentation](openid-connect.md) for more information.
