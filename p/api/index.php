...
$frameAncestors = Context::systemConf()->attributeString('csp.frame-ancestors') ?? "'none'";
...
Translate::init(Translate::getLanguage(null, Request::getPreferredLanguages(), null));
?>
<!DOCTYPE html>
...
<dd><kbd><?= Url::display('/api/greader.php', 'html', true) ?></kbd></dd>
<dt><?= _t('api.information.test.greader') ?></dt>
<dd id="greaderOutput"
	data-api-url="<?= Url::display('/api/greader.php', 'php', true) ?>"
...
<dd><kbd><?= Url::display('/api/fever.php', 'html', true) ?></kbd></dd>
<dt><?= _t('api.information.test.fever') ?></dt>
<dd id="feverOutput"
	data-api-url="<?= Url::display('/api/fever.php', 'php', true) ?>"
	data-i18n-pass="<?= _t('api.information.output.pass') ?>"
	data-i18n-invalid-configuration="<?= _t('api.information.output.invalid-configuration') ?>"
	data-i18n-unknown-error="<?= _t('api.information.output.unknown-error') ?>"
>?</dd>
...
<dl>
<dt><?= _t('api.information.address') ?></dt>
<dd><kbd><?= Url::display('/api/misc.php/Extension%20name/', 'html', true) ?></kbd></dd>
</dl>
