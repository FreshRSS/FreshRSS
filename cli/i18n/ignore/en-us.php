...
return array(
	...
	'admin.system.registration.select.label',
	'admin.system.registration.select.option.noform',
	'admin.system.registration.select.option.nolimit',
	'admin.system.registration.select.option.setaccountsnumber',
	'admin.system.registration.status.disabled',
	'admin.system.registration.status.enabled',
	'admin.update._',
	'admin.update.apply',
	'admin.update.check',
	...
	'install.missing_applied_migrations',
	'install.ok',
	'install.session.nok',
	'install.step',
	'install.steps',
	...
	'sub.title.add_feed',
	'sub.title.add_label',
	'sub.title.delete_label',
	'sub.title.feed_management',
	'sub.title.rename_label',
	...
	'user.email.validation.feedback.unnecessary',
