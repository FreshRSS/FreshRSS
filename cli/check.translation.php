...
require_once('./i18n/I18nCompletionValidator.php');
require_once('./i18n/I18nUsageValidator.php');
...
foreach ($languages as $language) {
	if ($language === $i18nData::REFERENCE_LANGUAGE) {
		...
		$isValidated = $i18nValidator->validate(include('./i18n/ignore/' . $language . '.php')) && $isValidated;
	} else {
