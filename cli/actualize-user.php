...
$nb = FreshRSS_category_Controller::refreshDynamicOpmls();
if ($nb === false) {
	fwrite(STDERR, "FreshRSS error refreshing dynamic OPMLs!\n");
} elseif ($nb > 0) {
	echo "FreshRSS refreshed $nb dynamic OPMLs for $username\n";
}
