...
| App                                                                                   | Platform    | Free Software                                                 | Maintained & Developed | API              | Works offline | Fast sync | Sync individual views | Sync read articles | Favourites | Labels | Podcasts | Manage feeds |
|:--------------------------------------------------------------------------------------|:-----------:|:-------------------------------------------------------------:|:----------------------:|:----------------:|:-------------:|:---------:|:---------------------:|:------------------:|:----------:|:------:|:--------:|:------------:|
...
| [ChristopheHenry](https://git.feneas.org/christophehenry/freshrss-android)            | Android     | [✔️](https://git.feneas.org/christophehenry/freshrss-android) | ✔️✔️                   | GReader          | ✔️            | ❔        | ➖                    | ❔                 | ❔         | ➖     | ➖       | ➖           |
