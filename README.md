...
Mobile and native apps connect to FreshRSS via two APIs: [Google Reader API](https://freshrss.github.io/FreshRSS/en/developers/06_GoogleReader_API.html) (best) and [Fever API](https://freshrss.github.io/FreshRSS/en/developers/06_Fever_API.html) (limited features, less efficient, less safe).

<details>
<summary>Compare all 20 supported apps and their feature support</summary>

<!-- Rows sorted alphabetically by App name. New entries: insert in alphabetical position. -->

| App                                                                                   | Platform    | FOSS                                                          | Status      | API     | Offline | Sync efficiency | Per-feed history | Imports read items  | Favourites | Labels | Podcasts | Manage feeds |
|:--------------------------------------------------------------------------------------|:-----------:|:-------------------------------------------------------------:|:-----------:|:-------:|:-------:|:----------:|:----------------:|:-------------------:|:----------:|:------:|:--------:|:------------:|
| [Capy Reader](https://github.com/jocmp/capyreader)                                    | Android     | [✓](https://github.com/jocmp/capyreader)                      | Active      | GReader | ✓             | ⭐⭐⭐    | ✓                | ✓                   | ✓          | ✓      | [✓](https://github.com/jocmp/capyreader/discussions/1689) | ✓            |
| [FeedFlow](https://www.feedflow.dev)                                                  | Android, iOS, Linux, macOS, Windows | [✓](https://github.com/prof18/feed-flow) | Active      | GReader | ✓             | ?         | ?                | ?                   | ✓          | ?      | ?        | ✓            |
| [FeedMe](https://play.google.com/store/apps/details?id=com.seazon.feedme)             | Android     | [✗](https://github.com/seazon/FeedMe)                         | Active      | GReader | ✓             | ⭐⭐      | ✗                | ✗                   | ✓          | [✓](https://github.com/seazon/FeedMe/issues/348) | ✓        | ✓            |
| [Fiery Feeds](https://voidstern.net/fiery-feeds)                                      | iOS         | ✗                                                             | Active      | Fever   | ?             | ?         | ?                | ?                   | ?          | ✗      | ✗        | ✗            |
| [Fluent Reader](https://hyliu.me/fluent-reader/)                                      | Windows, Linux, macOS | [✓](https://github.com/yang991178/fluent-reader)    | Active      | GReader | ✓             | ⭐        | ✗                | ✓                   | ✓          | ✗      | ✗        | ✗            |
| [Fluent Reader Lite](https://hyliu.me/fluent-reader-lite/)                            | Android, iOS| [✓](https://github.com/yang991178/fluent-reader-lite)         | Maintenance | GReader | ✓             | ⭐⭐      | ✗                | ✗                   | ✓          | ✗      | ✗        | ✗            |
| [FluentFlame Reader](https://github.com/FluentFlame/fluentflame-reader)               | Windows, Linux, macOS | [✓](https://github.com/FluentFlame/fluentflame-reader) | WIP         | GReader | ?             | ?         | ?                | ?                   | ✓          | ?      | ?        | ?            |
| [FocusReader](https://play.google.com/store/apps/details?id=allen.town.focus.reader)  | Android     | ✗                                                             | Active      | GReader | ✓             | ⭐⭐      | ✗                | ✗                   | ✓          | ✓      | ✓        | ✓            |
| [lire](https://lireapp.com/)                                                          | iOS, macOS  | ✗                                                             | Active      | GReader | ?             | ?         | ?                | ?                   | ?          | ?      | ?        | ?            |
| [Netnewswire](https://ranchero.com/netnewswire/)                                      | iOS, macOS  | [✓](https://github.com/Ranchero-Software/NetNewsWire)         | WIP         | GReader | ✓             | ?         | ?                | ?                   | ✓          | ✗      | ?        | ✓            |
| [Newsboat](https://newsboat.org/)                                                     | Linux, macOS, FreeBSD | [✓](https://github.com/newsboat/newsboat/)          | Active      | GReader | ✗             | ⭐        | ✗                | ✓                   | ✓          | ✗      | ✓        | ✗            |
| [NewsFlash](https://gitlab.com/news-flash/news_flash_gtk)                             | Linux       | [✓](https://gitlab.com/news-flash/news_flash_gtk)             | Active      | GReader | ✗             | ⭐⭐      | ✗                | ✓                   | ✓          | ✓      | ✗        | ✗            |
| [Read You](https://github.com/Ashinch/ReadYou/)                                       | Android     | [✓](https://github.com/Ashinch/ReadYou/)                      | Active      | GReader | ✓             | ⭐⭐      | ✓                | ✓                   | ✓          | ✗      | ✗        | ✓            |
| [Readkit](https://readkit.app/)                                                       | iOS, macOS  | ✗                                                             | Active      | GReader | ✓             | ⭐⭐⭐    | ✗                | ✓                   | ✓          | ✗      | ✓        | $            |
| [Readrops](https://github.com/readrops/Readrops)                                      | Android     | [✓](https://github.com/readrops/Readrops)                     | Maintenance | GReader | ✓             | ⭐⭐⭐    | ✗                | ✓                   | ✓          | [✗](https://github.com/readrops/Readrops/issues/54) | ✗        | ✓            |
| [Reeder Classic](https://www.reederapp.com/classic/)                                  | iOS, macOS  | ✗                                                             | Maintenance | GReader | ✓             | ⭐⭐⭐    | ✗                | ✓                   | ✓          | ✗      | ✗        | ✓            |
| [RSS Guard](https://github.com/martinrotter/rssguard)                                 | Windows, Linux, macOS, OS/2 | [✓](https://github.com/martinrotter/rssguard)   | Active      | GReader | ✓             | ⭐⭐      | ✗                | ✓                   | ✓          | ✓      | ✓        | ✓            |
| [Unread](https://www.goldenhillsoftware.com/unread/)                                  | iOS         | ✗                                                             | Active      | Fever   | ✓             | ?         | ?                | ?                   | ✓          | ✗      | ✗        | ✗            |
| [Vienna RSS](http://www.vienna-rss.com/)                                              | macOS       | [✓](https://github.com/ViennaRSS/vienna-rss)                  | Active      | GReader | ?             | ?         | ?                | ?                   | ?          | ?      | ?        | ?            |
| [Your News](https://yournews.app/)                                                    | Android, iOS| ✗                                                             | Active      | GReader | ✗             | ⭐        | ✓                | ✓                   | ✓          | ✗      | ✗        | ✗            |

* **Status**: *Active* (maintained and developed), *Maintenance* (bug fixes only), *WIP* (in development, not yet released), *Abandoned*.
* **Sync efficiency**: ⭐⭐⭐ full sync in fewer than 8 requests with no content re-transfer; ⭐⭐ a few inefficiencies but acceptable; ⭐ wasteful patterns like one request per feed/category/label, unneeded paging, or re-fetching article content.
* **Per-feed history**: when viewing a single feed, folder, or label, the app can load older entries from the server *on demand* (beyond what the regular sync brings down).
* **Imports read items**: during normal *automatic* sync, the app fetches articles already marked read on the server (e.g. via the web UI) that the app has never seen.
