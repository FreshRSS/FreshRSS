...
enum Minz_HookType: string {
	...
	case CheckUrlBeforeAdd = 'check_url_before_add';	// function($url) -> Url | null
	...
	case EntryBeforeDisplay = 'entry_before_display';	// function($entry) -> Entry | null
	case EntryBeforeInsert = 'entry_before_insert';	// function($entry) -> Entry | null
	case EntryBeforeAdd = 'entry_before_add';	// function($entry) -> Entry | null
	case EntryBeforeUpdate = 'entry_before_update';	// function($entry) -> Entry | null
	case FeedBeforeActualize = 'feed_before_actualize';	// function($feed) -> Feed | null
	case FeedBeforeInsert = 'feed_before_insert';	// function($feed) -> Feed | null
