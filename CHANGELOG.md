...
* Bug fixing
	...
	* Fix search `date:`/`pubdate:`/`mdate:`/`userdate:` filters with a negative UTC offset (e.g. `-05:00`) parsing to the wrong date [#7923](https://github.com/FreshRSS/FreshRSS/issues/7923)
